...
namespace TAP21_22.AuctionSite.Testing {
    internal static class Configuration {
        internal const string StudentSpace = @"..\..\..\..\";
        internal const string CurrentStudent = "Scazzola";
        internal static Dictionary<string, string> Implementations = new Dictionary<string, string>() {
            ["Scazzola"] = @"ScazzolaImplementation\bin\Debug\net5.0\ScazzolaImplementation.dll"
        };

        //MIEI 2018/19
        //internal const string ImplementationAssembly = @"..\..\..\..\TAP21-22.AuctionSite.RefImpl\bin\Debug\net5.0\TAP21-22.AuctionSite.RefImpl.dll";

        //internal const string ConnectionString = @"Data Source=.;Initial Catalog=ProvaDotNet5;Integrated Security=True;";

        // STUDENTI
        internal static string ImplementationAssembly =
            StudentSpace+Implementations[CurrentStudent];
        internal const string ConnectionString =
            @"Data Source=.;Initial Catalog="+CurrentStudent+"DB665;Integrated Security=True;";
    }
